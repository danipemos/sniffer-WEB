...
urlpatterns = [
    ...
    path("private_keys/delete/<int:key_id>/", views.delete_private_key, name="delete_private_key"),
    path("private_keys/edit/<int:key_id>", views.edit_private_key, name="edit_private_key"),
